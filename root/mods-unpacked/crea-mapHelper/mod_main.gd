...
const MOD_DIR := "crea-mapHelper" # Name of the directory that this file is in
const LOG_NAME := "crea-mapHelper:Main" # Full ID of the mod (AuthorName-ModName)
...
func install_script_extensions() -> void:
	...
	ModLoaderMod.install_script_extension(extensions_dir_path.path_join("Scripts/Maps/MapSpawner.gd"))
...
func _create_loader() -> Node:
	var loader = load(mod_dir_path.path_join("map_loader.gd")).new(mod_dir_path) # omg loader from RoR mentioned??? :O
